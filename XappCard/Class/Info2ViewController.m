...
- (void)loadView{
	...
	backB = [UIButton buttonWithFrame:CGRectMake(3, 3, isPad?60:30, isPad?60:30) title:nil imageName:@"icon_back.png" target:self actcion:@selector(back)];
...
//	https://itunes.apple.com/app/id540321553?mt=8
