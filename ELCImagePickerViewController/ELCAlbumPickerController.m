...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath {
  ...
  //  DLog(@"asset.photo number:%d",[picker.assetGroup numberOfAssets]);
    
	//[self.navigationController pushViewController:picker animated:YES];
	[self performSelector:@selector(push:) withObject:picker afterDelay:0.5];
...
#pragma mark - 
- (void) push:(ELCAssetTablePicker*)pick{
 //   L();
